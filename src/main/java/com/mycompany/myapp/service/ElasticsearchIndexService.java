...
public class ElasticsearchIndexService {
    ...
    public ElasticsearchIndexService(
        ...
        DroitSearchRepository droitSearchRepository,
        SprintRepository sprintRepository,
        SprintSearchRepository sprintSearchRepository,
        TagRepository tagRepository,
        TagSearchRepository tagSearchRepository,
        UserStoryRepository userStoryRepository,
        UserStorySearchRepository userStorySearchRepository,
    ...
    public void reindexAll() {
        if (reindexLock.tryLock()) {
            try {
                reindexForClass(Droit.class, droitRepository, droitSearchRepository);
                reindexForClass(Sprint.class, sprintRepository, sprintSearchRepository);
