...
import { UserStoryComponent } from 'app/entities/user-story/user-story.component';
...
describe('Component Tests', () => {
  describe('UserStory Management Component', () => {
    let comp: UserStoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserStoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userStories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
